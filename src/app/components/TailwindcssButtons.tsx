...
export const buttons = [
  {
    ...
    showDot: false,
    component: (
      <button className="relative inline-flex h-10 overflow-hidden rounded-full p-[3px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
